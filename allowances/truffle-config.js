...
const pk = process.env.PRIVATE_KEYS;
  ...
  networks: {
    ...
    moonbase: {
      provider: () => {
        return new HDWalletProvider(
          pk,
          "https://rpc.moonbase.multisig.moonbeam.network"
        );
      },
      network_id: "1287",
    ...
    evmos: {
      provider: () => {
        return new HDWalletProvider(pk, "https://eth.bd.evmos.org:8545");
      },
      network_id: "9001",
      gasPrice: 27500000000, // 27.5 Gwei
    },
    evmos_testnet: {
      provider: () => {
        return new HDWalletProvider(pk, "https://eth.bd.evmos.dev:8545");
      },
      network_id: "9000",
      gasPrice: 13750000, // wei
    },
  },
  compilers: {
    solc: {
